...
function t(i, r) {
  ...
  return n ? n[1] ? /^sti/i.test(r) ? 1 : 0 : n[2] ? /^image-/i.test(r) ? 1 : 0 : n[3] ? "-" === r[3] ? 2 : 0 : /^(inline-)?grid$/i.test(r) ? 4 : 0 : 0;
}
...
var apply = (...tokens) => directive(applyFactory, tokens); // src/twind/helpers.ts
...
var edges = /* @__PURE__ */positions(expandEdges); // src/twind/plugins.ts
...
var silent = /* @__PURE__ */mode(noop); // src/twind/prefix.ts
...
var defaultTheme = {
  ...
  brightness: { ... /* @__PURE__ */linear(200, "", 100, 0, 50),
    ... /* @__PURE__ */linear(110, "", 100, 90, 5),
    75: "0.75",
    125: "1.25"
  },
  borderColor: theme2 => ({ ...theme2("colors"),
  ...
  contrast: { ... /* @__PURE__ */linear(200, "", 100, 0, 50),
    75: "0.75",
    125: "1.25"
  },
  ...
  maxHeight: theme2 => ({ ...theme2("spacing"),
    full: "100%",
    screen: "100vh"
  }),
  maxWidth: (theme2, {
  ...
  opacity: { ... /* @__PURE__ */linear(100, "", 100, 0, 10),
    5: "0.05",
    25: "0.25",
    75: "0.75",
    95: "0.95"
  ...
  rotate: { ... /* @__PURE__ */exponential(2, "deg"),
    ... /* @__PURE__ */exponential(12, "deg", 3),
    ... /* @__PURE__ */exponential(180, "deg", 45)
  },
  saturate: /* @__PURE__ */linear(200, "", 100, 0, 50),
  scale: { ... /* @__PURE__ */linear(150, "", 100, 0, 50),
    ... /* @__PURE__ */linear(110, "", 100, 90, 5),
    75: "0.75",
    125: "1.25"
  },
  ...
  skew: { ... /* @__PURE__ */exponential(2, "deg"),
    ... /* @__PURE__ */exponential(12, "deg", 3)
  },
  ...
  translate: theme2 => ({ ...theme2("spacing"),
    ...ratios(2, 4),
    full: "100%"
  }),
  width: theme2 => ({
...
var declarationPropertyPrecedence = property2 => property2[0] == "-" ? 0 : seperatorPrecedence(property2) + ((_3 = /^(?:(border-(?!w|c|sty)|[tlbr].{2,4}m?$|c.{7}$)|([fl].{5}l|g.{8}$|pl))/.exec(property2)) ? +!!_3[1] || -!!_3[2] : 0) + 1; // src/twind/serialize.ts
...
var serialize = (prefix, variants, context) => {
  ...
  const stringify3 = (atRules, selector, presedence, css, important) => {
    ...
    if (css["@apply"]) {
      css = merge(evalThunk(apply(css["@apply"]), context), { ...css,
        "@apply": void 0
      }, context);
    }
...
var configure = (config = {}) => {
  ...
  const translate2 = translate({ ...corePlugins,
    ...config.plugins
  }, context);
  ...
  if (preflight) {
    ...
    const styles = serialize2(typeof preflight == "function" ? evalThunk(preflight(css, context), context) || css : { ...css,
      ...preflight
    });
...
export { apply as a, cssomSheet as b, create as c, directive as d, setup as s };
